...
class KfcScreen extends StatefulWidget {
  const KfcScreen  ({Key? key}) : super(key: key);

  @override
  State<KfcScreen > createState() => _KfcScreenState();
}

class _KfcScreenState extends State<KfcScreen > {
  int count=1;
  int calory=70;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('KFC',style: TextStyle(color:Colors.green),),
