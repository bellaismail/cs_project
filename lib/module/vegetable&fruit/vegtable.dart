...
class VetableScreen extends StatefulWidget {

  @override
  State<VetableScreen> createState() => _VetableScreenState();
}

class _VetableScreenState extends State<VetableScreen> {
  int count=1;
  int calory=70;
  @override
  Widget build( context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Vegetable',style: TextStyle(color:Colors.green),),
